...
(function(){
    ...
    let m = dt.getMinutes();
    let s = dt.getSeconds();
    let showTimeDom = document.querySelector(".showTime");
    showTimeDom.innerHTML = '当前时间：' + y + "年" + mt + "月" 
    + day + "-" + h + "时" + m + "分" + s + "秒";
...
//柱状图模块1
//立即执行函数，都是局部变量，不用担心命名重复(function(){})();
(function(){
...
(function(){
  ...
  let yearData = [
    ...
    $(".line1 h2").on("click","a",function(){
      ...
      //点击a之后，根据a返回的索引号找到对应的yearData里面的相关对象
    ...
    series: [
      {
        ...
        showSymbol:false,
        data: [ 
          30, 40, 30, 40, 30, 40, 30, 60,
          20, 40, 30, 40, 30, 40, 30, 40, 
      ...
      },
      {
        ...
        showSymbol:false,
        data: [ 
          130, 10, 20, 40, 30, 40, 80, 60, 20, 
          40, 90, 40, 20, 140, 30, 40, 130, 20, 
          20, 40, 80, 70, 30, 40, 30, 120, 20, 99,50, 20
        ]
      }
    ]
  };
...
(function(){
  ...
  let option = {
    ...
    tooltip: {
      ...
      //{a}:series的name值
      //<br/>:换行
      //{b}:series里data里每个对象的name值
      //{c}:series里data里每个对象的value值
      //{d}:该对象在整个饼图中的占比
    ...
    series: [
      {
        ...
        //而我们饼形图是通过 radius 修改大小 , 百分比是相对于容器宽度来说的
        radius: ['40%', '60%'],
        //饼图水平垂直居中
        center:['50%','45%'],
        //不显示标签
